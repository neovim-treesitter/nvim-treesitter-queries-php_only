# nvim-treesitter-queries-php_only

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-php_only/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-php_only/actions/workflows/validate.yml)

Neovim tree-sitter queries for **php_only**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-php_only",
...
- [ ] Changes are scoped to `php_only` — do not include files for other languages
